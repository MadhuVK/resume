...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Analyzed the crytographic security of IPFS, a peer-to-peer distributed protocol and application suite.
          (\underline{\href{https://www.madhuvk.com/ipfs_security.pdf}{Paper}})}
      \end{cvitems}
    }
